            ...
            <div className="flex flex-col lg:flex-row-reverse items-start w-full gap-6 p-6">
              <div className="flex flex-col gap-3 w-full lg:w-auto lg:min-w-[280px] mb-4">
                ...
                <button
                  ...
                  className={`border-2 cursor-pointer border-blue-600 text-blue-600 rounded-xl py-3 px-4 font-bold text-lg hover:bg-blue-50 transition-all duration-200 transform hover:scale-105 ${isSatelliteView
                    ? "bg-blue-600 text-white hover:bg-blue-700"
                    : ""
                    }`}
                >
