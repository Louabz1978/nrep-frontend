...
function StatusStep({ form, setCurrentStep }: StatusStepProps) {
  ...
  return (
    <form id="status_step_form" onSubmit={form.handleSubmit(onSubmit)}>
      <PageContainer>
        <div className="flex flex-row min-w-7xl  bg-[#FDF9EF]">
          <div className="min-h-100 flex">
            <div className="rounded-lg text-black  w-full mt-3">
              ...
              {/*paragraph*/}
              <div className="text-right max-w-5xl mr-12 text-base text-[#1C2026] mb-8 w-full">
              ...
              <div className="flex flex-col items-center w-full mb-8">
                ...
                <div className="flex gap-2">
                  <button
                    type="button"
                    className={`px-8 py-2 rounded-lg cursor-pointer ${status === "active"
                  ...
                  <button
                    type="button"
                    className={`px-8 py-2 rounded-lg cursor-pointer ${status === "incomplete"
