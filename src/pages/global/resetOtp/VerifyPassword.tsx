...
const VerifyPassword = () => {
  ...
  const onSubmit: SubmitHandler<ResetPasswordFormType> = async ({ password }) => {
    if (!email || !token) {
      navigate("/login");
      return;
    }
  ...
  return (
    <AnimateContainer>
      ...
      >
        <div
          className="w-[410px] max-w-full gap-[16px] px-[80px] py-[40px] border-[var(--login-primary)] bg-white border-[2px] rounded-[28px] flex flex-col items-center"
        >
          <form
