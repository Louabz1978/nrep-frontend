              ...
              >
                ...
                {type == "custom" ? (
                  ...
                  <input
                    ...
                    className={
                      variant == "contract"
                        ? `w-full h-8 text-size15  border-b-1  rounded-none  duration-[0.3s]  ${addingInputStyle}`
                  ...
                  <input
                    ...
                    className={
                      variant == "contract"
                        ? `w-full h-8 text-size15  border-b-1  rounded-none outline-none  duration-[0.3s]  ${
