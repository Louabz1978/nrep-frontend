...
export const ContractFormSchema = Joi.object<ContractFormType>({
  ...
  seller_mothor_name: Joi.any().messages(VALIDATION_MESSAGES).label("اسم والدة البائع"),
  seller_birth_place: Joi.any().messages(VALIDATION_MESSAGES).label("مكان ولادة البائع"),
  seller_nation_number: Joi.any().messages(VALIDATION_MESSAGES).label("الرقم الوطني للبائع"),
  seller_registry: Joi.any().messages(VALIDATION_MESSAGES).label("رقم قيد البائع"),
  buyer_name: Joi.any().messages(VALIDATION_MESSAGES).label("المشتري"),
  buyer_mothor_name: Joi.any().messages(VALIDATION_MESSAGES).label("اسم والدة المشتري"),
  buyer_birth_place: Joi.any().messages(VALIDATION_MESSAGES).label("مكان ولادة المشتري"),
  buyer_nation_number: Joi.any().messages(VALIDATION_MESSAGES).label("الرقم الوطني للمشتري"),
  buyer_registry: Joi.any().messages(VALIDATION_MESSAGES).label("رقم قيد المشتري"),
  ...
  legal_description: Joi.any().messages(VALIDATION_MESSAGES).label("الوصف القانوني"),
  ...
  solar_system: Joi.any().messages(VALIDATION_MESSAGES).label("نظام طاقة شمسية"),
  ...
  deposit_date: Joi.any().messages(VALIDATION_MESSAGES).label("تاريخ الدفعة المقدمة"),
  batch: Joi.any().messages(VALIDATION_MESSAGES).label("الدفعة الثانية"),
  batch_date: Joi.any().messages(VALIDATION_MESSAGES).label("تاريخ الدفعة الثانية"),
  final_price: Joi.any().messages(VALIDATION_MESSAGES).label("السعر النهائي"),
  warranty_agent: Joi.any().messages(VALIDATION_MESSAGES).label("اسم وكيل الضمان"),
  warranty_agent_address: Joi.any().messages(VALIDATION_MESSAGES).label("عنوان وكيل الضمان"),
  warranty_agent_phone: Joi.any().messages(VALIDATION_MESSAGES).label("هاتف وكيل الضمان"),
  warranty_agent_email: Joi.any().messages(VALIDATION_MESSAGES).label("البريد الإلكتروني لوكيل الضمان"),
  warranty_agent_fax: Joi.any().messages(VALIDATION_MESSAGES).label("فاكس وكيل الضمان"),
  addtion_batch_days: Joi.any().messages(VALIDATION_MESSAGES).label("عدد أيام الدفعة الإضافية"),
  addtion_batch_date: Joi.any().messages(VALIDATION_MESSAGES).label("تاريخ الدفعة الإضافية"),
