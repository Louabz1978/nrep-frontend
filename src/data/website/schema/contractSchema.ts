...
export const ContractFormSchema = Joi.object<ContractFormType>({
  ...
  sller_agent_name: Joi.any().messages(VALIDATION_MESSAGES).label("وكيل البائع"),
  seller_agent_license: Joi.any().messages(VALIDATION_MESSAGES).label("رخصة وكيل البائع"),
  seller_agent_broker_license: Joi.any().messages(VALIDATION_MESSAGES).label("رخصة البروكر"),
  seller_agent_broker: Joi.any().messages(VALIDATION_MESSAGES).label("سمسار وكيل البائع"),
  seller_company_address: Joi.any().messages(VALIDATION_MESSAGES).label("عنوان شركة البائع"),
  seller_company_phone: Joi.any().messages(VALIDATION_MESSAGES).label("هاتف شركة البائع"),
  buyer_agent: Joi.any().messages(VALIDATION_MESSAGES).label("وكيل المشتري"),
  buyer_agent_license: Joi.any().messages(VALIDATION_MESSAGES).label("رخصة وكيل المشتري"),
  buyer_agent_broker_license: Joi.any().messages(VALIDATION_MESSAGES).label("رخصة البروكر"),
  buyer_agent_broker: Joi.any().messages(VALIDATION_MESSAGES).label("سمسار وكيل المشتري"),
  buyer_company_address: Joi.any().messages(VALIDATION_MESSAGES).label("عنوان شركة المشتري"),
  buyer_company_phone: Joi.any().messages(VALIDATION_MESSAGES).label("هاتف شركة المشتري"),
});
